...
O curso "Formação ASP.NET Core" foi idealizado e ministrado pelo instrutor [Luis Felipe](https://www.linkedin.com/in/luisdeol/) com ajuda do README do [@LecioVilela](https://github.com/LecioVilela).
